...
public interface ResponseUtil {
	/**
	 * Wrap the mono into a {@link org.springframework.http.ResponseEntity} with an
	 * {@link org.springframework.http.HttpStatus#OK} status, or if it's empty, it
	...
	/**
	 * Wrap the mono into a {@link org.springframework.http.ResponseEntity} with an
	 * {@link org.springframework.http.HttpStatus#OK} status with the headers, or if
	 * it's empty, throws a
