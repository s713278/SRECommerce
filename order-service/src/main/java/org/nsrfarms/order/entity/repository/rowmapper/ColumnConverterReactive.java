...
/**
 * Interface used in the (@link ConditionBuilder) to help build literal 'value
 * expression' of the Conditions. Converters registered in the (@link
 * DataBaseConfiguration) of the Springboot app will be used for the
 * datatype/data conversion
 *
 */
